...
const Reports = () => {
  const reportsList = resources.filter(r => r.type === 'report');
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Explore our comprehensive research studies, impact evaluations, and strategic policy briefs on education, environment, and civic tech.
            </p>
          </div>
        </div>
      </section>
